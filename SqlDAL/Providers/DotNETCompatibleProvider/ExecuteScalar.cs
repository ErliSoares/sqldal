...
namespace System.Data.DBAccess.Generic.Providers.DotNETCompatibleProvider
{
    ...
    {
        /// <summary>
        /// Executes a scalar return operation against a database using the provided options.
        /// </summary>
        /// <returns>The scalar value returned by the server.</returns>
        public virtual Object ExecuteScalar()
        {
            return this.ExecuteSql<Object>((cmd) =>
            {
